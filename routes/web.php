...
// Route::get('/', [AuthenticationController::class, 'login_cover'])->name('auth-login-cover');
...
Route::group(['prefix' => 'master'], function () {
    ...
    Route::get('coa', [MasterController::class, 'coa'])->name('master-coa');    /* Route Master Lokasi Start*/
    ...
    Route::get('grup/perusahaan', [MasterController::class, 'grup'])->name('master-grup-perusahaan');
    Route::post('grup/store', [GrupController::class, 'store'])->name('grup-store');
    Route::delete('grup/delete/{id}', [GrupController::class, 'destroy'])->name('grup-delete');
...
Route::group(['prefix' => 'perusahaan'], function () {
    ...
    Route::post('/delete', [App\Http\Controllers\Master\PerusahaanController::class, 'delete'])->name('delete');
