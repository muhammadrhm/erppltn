              ...
              <table class="table">
                <thead>
                  <tr>
                    ...
                    <th>Nomor</th>
                    <th>Nama</th>
                    <th>Nomor Foreign Key</th>
                    <th>Nama Foreign Key</th>
                    <th>Tanggal</th>
                    <th>Penambah</th>
                    <th>Status</th>
                    <th>Aksi</th>
                ...
                <tbody>
                  ...
                  @foreach($datas as $data)
                    <tr>
                      ...
                      <td>{{$no++}}</td>
                      <td>
                        <span class="fw-bold">{{$data->nomor}}</span>
                      </td>
                      <td>
                        <span class="fw-bold">{{strtoupper($data->nama)}}</span>
                      </td>
                      <td>
                        <span class="fw-bold">{{$data->nomorforeignkey}}</span>
                      </td>
                      <td>
                        <span class="fw-bold">{{strtoupper($data->namaforeignkey)}}</span>
                      </td>
      ...
      <div class="modal-dialog">
        <form class="modal-content pt-0" method="POST" action="{{route('grupcoa-store')}}">
          ...
          <div class="modal-body flex-grow-1">
            ...
            <div class="mb-1">
              <label class="form-label" for="basic-icon-default-fullname">Nomor Foreign Key</label>
              <input
                type="number"
                class="form-control dt-full-name"
                id="basic-icon-default-fullname"
            ...
            <div class="mb-1">
              <label class="form-label" for="basic-icon-default-fullname">Nama Foreign Key</label>
              <input
                type="text"
                class="form-control dt-full-name"
                id="basic-icon-default-fullname"
            ...
            <div class="mb-1">
              ...
              <select id="country" class="select2 form-select" name="aktif">
